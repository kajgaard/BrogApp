...
public class PreMadeBrewsActivity extends AppCompatActivity implements FavoritesAdapter.OnListItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_premades);

        fStore = FirebaseFirestore.getInstance();
        fAuth = FirebaseAuth.getInstance();
        userID = fAuth.getCurrentUser().getUid();
        //Query for database
        Query query = fStore.collection("brews");
    ...
    public void brygPush(View view) {
        ...
        Intent intent = new Intent(PreMadeBrewsActivity.this, BrewStartedActivity.class);
