...
public class BrewFaveAdapter extends FirestorePagingAdapter<BrewItem, BrewFaveAdapter.BrewFaveViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull BrewFaveAdapter.BrewFaveViewHolder holder, int position, @NonNull BrewItem model) {
    ...
    @NonNull
    @Override
    public BrewFaveAdapter.BrewFaveViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.brewfaves_adapter, parent, false);
        return new BrewFaveAdapter.BrewFaveViewHolder(v);
    }
